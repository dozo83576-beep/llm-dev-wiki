...
Сохранять все подряд, смешивать факты и гипотезы, хранить секреты, не удалять устаревшие предпочтения, считать memory заменой audit/evals.
...
См. [lessons template](../../lessons-learned/_template.md), [Agent workflows](Agent-workflows.md), [Agent self-improvement loop](Agent-self-improvement.md).
