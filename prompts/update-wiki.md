...
Проект или этап завершён. Без обновления вики опыт растворится в чате. Нужны конкретные записи (success / failure / lesson / pattern / checklist update), а не общие "молодцы".
...
1. **Decide artifact type**: success / failure / lesson / pattern / checklist update / новый playbook.
...
5. **MEMORY**: ничего секретного / PII / приватного кода. Если есть — anonymize.
6. **Knowledge index**: обновить [docs/INDEX.md](../docs/INDEX.md), если затронуты основные разделы.
