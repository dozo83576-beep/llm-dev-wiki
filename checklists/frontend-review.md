...
- [ ] **Layout consistency smoke**: проверены единые content gutters, отсутствие horizontal overflow и карточки/формы в пределах viewport — QA + design owner — warn — [Lead landing Playwright smoke](../docs/09-testing/Lead-landing-playwright-smoke.md).
