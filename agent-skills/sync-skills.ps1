...
.DESCRIPTION
    Канон скиллов хранится в D:\Work\llm-dev-wiki\agent-skills. D:\Work\.agent-skills — runtime cache.
    Каждый подкаталог с файлом SKILL.md — это скилл.
    Скрипт обновляет runtime cache D:\Work\.agent-skills и копирует ТОЛЬКО эти скиллы в:
...
.PARAMETER RuntimeRoot
    Путь runtime cache. По умолчанию D:\Work\.agent-skills.
...
.EXAMPLE
    ...
    pwsh D:\Work\.agent-skills\sync-skills.ps1 -Codex
#>
param(
    [switch]$Claude,
    [switch]$Codex,
